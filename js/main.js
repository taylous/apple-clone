  ...
  const sceneInfo = [
    {
      ...
      values: {
        /**
         * message A의 경우에는 스크롤이,
         * 전체의 10%에서 시작해서 20%일 때 서서히 나타난다.
         */
        messageA_opacity_in: [0, 1, { start: 0.1, end: 0.2 }],
        /**
         * message B의 경우에는 스크롤이,
         * 전체의 30%에서 시작해서 40%일 때 서서히 나타난다.
         */
    ...
    },
    {
      // 1
      type: "normal",
      // heightNum: 5, // type normal is deprecated
      scrollHeight: 0,
      objs: {
